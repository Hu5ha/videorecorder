...
public class AprilTagDetectionFromCamera: MonoBehaviour
{
    ...
    void LateUpdate()
    {
        RenderTexture renderTexture = ARCamera.GetComponent<Camera>().activeTexture;
            //textureDemuxer.unDestortedColorTexture;
