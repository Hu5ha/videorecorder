...
public sealed class BibcamXRDataProvider : MonoBehaviour
{
    ...
    void OnCameraFrameReceived(ARCameraFrameEventArgs args)
    {
        ...
        //
        Debug.Log("Debug: OnCameraFrameReceived, args.textures.Count = " + args.textures.Count);
    ...
    {
        Debug.Log("Debug: OnOcclusionFrameReceived, args.textures.Count = " + args.textures.Count);
